...
{
    public partial class FormGiaoDienDam2 : System.Windows.Forms.Form
    {
        ...
        public FormGiaoDienDam2()
        {
            ...
            ShowThepGia(false);
            //pnGiaCuongDauDam1Lop1.Visible = false;
            //pnGiaCuongDauDam1Lop2.Visible = false;
            //pnGiaCuongDauDam2Lop1.Visible = false;
            //pnGiaCuongDauDam2Lop2.Visible = false;
            //pnKhoangCachThepChu.Size = new Size(200, 72);
            ...
            //cbThepVaiBoDau1.Checked = false;
            //cbThepVaiBoDau2.Checked = false;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            finally
            {
                ...
                GRThepDaiKep(cbThepDaiLong.Checked);
        ...
        private void cbThepChu1Lop_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                gbThepDuoi2.Visible = true; cbThepTren2.Visible = true;
        ...
        private void cbThepTren2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    gbThepTren2.Enabled = false;
            //    //    cbGiaCuongNhip.Text = "Thép gia cường nhịp";
            //    //    numThepGiaCuongNhipDuongKinh.Visible = false;
            //    //    numThepGiaCuongNhipSoLuong.Visible = false;
            //    //    lblGiaCuongNhipSoLuongThep.Visible = false;
            //}
            //else
            //{
            //    gbThepTren2.Enabled = true;
            //    //    cbGiaCuongNhip.Text = "Nhịp: Đường kính";
            //    //    numThepGiaCuongNhipDuongKinh.Visible = true;
            //    //    numThepGiaCuongNhipSoLuong.Visible = true;
            //    //    lblGiaCuongNhipSoLuongThep.Visible = true;
            //}
        }
        ...
        private void cbThepDuoi2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    gbThepDuoi2.Enabled = false;
            //}
            //else
            //{
            //    gbThepDuoi2.Enabled = true;
            //}
        }
        ...
        private void rdGiaCuong2Lop_CheckedChanged(object sender, EventArgs e)
        {
            ...
            switch (rd.Name)
            {
                ...
                case "cbThepGiaCuongGL1":
                    ...
                    //pnGiaCuongGiuaL1.Visible = rd.Checked;
                    //pnGiaCuongGiuaL1.Enabled = rd.Checked;
                    break;
                case "cbThepGiaCuongGL2":
                    pnGiaCuongGiuaDamLop2.Visible = rd.Checked;
                    //pnGiaCuongGiuaL2.Visible = rd.Checked;
                    //pnGiaCuongGiuaL2.Enabled = rd.Checked;
                    break;
        ...
        private void FormGiaoDienDam2_Load(object sender, EventArgs e)
        {
            string loaiCauKien = dictLuuParam["LOAI CAU KIEN"].AsString();
        ...
        {
            {
                if (cbThepDaiC.Checked)
                {
                    if (cbThepDaiCDungDon.Checked)
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungDonCheck, 1);
                    }
                    else
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungDonCheck, 0);
                    }
                    if (cbThepDaiCDungKep.Checked)
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepCheck, 1);
                        if (cbThepDaiCDungKepBen1.Checked)
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen1, 1);
                        else
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen1, 0);
                        if (cbThepDaiCDungKepBen2.Checked)
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen2, 1);
                        else
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen2, 0);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepN, numThepDaiCDungKepN.Value);

                    }
                    else
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepCheck, 0);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen1, 0);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCDungKepBen2, 0);
                    }
                    ...
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangTrenCheck, 1);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangTrenD, numThepDaiCNgangTrenD.Value);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangTrenR, numThepDaiCNgangTrenR.Value);
                    }
                    else
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangTrenCheck, 0);
                    }
                    if (cbThepDaiCNgangDuoi.Checked)
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangDuoiCheck, 1);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangDuoiD, numThepDaiCNgangDuoiD.Value);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangDuoiR, numThepDaiCNgangDuoiR.Value);
                    }
                    else
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCNgangDuoiCheck, 0);
                    }
        ...
        private void CommandChoThepDaiLong(Dictionary<string, object> dictCacGiaTriThepCanDoi)
        {
            ...
            if (cbbLoaiDam.Text.Contains("C") || cbbLoaiDam.Text.Contains("D"))
            {
                if (cbThepDaiLong.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongDonCheck, 1);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongDonN, numThepDaiLongSoLuong.Value);
                }
                else
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongDonCheck, 0);
                }
                if (cbDaiLongKep.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepCheck, 1);
                    if (cbDaiLongKepBen1.Checked)
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen1, 1);
                    else
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen1, 0);
                    if (cbDaiLongKepBen2.Checked)
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen2, 1);
                    else
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen2, 0);
                    if (cbDaiLongKepBen1.Checked || cbDaiLongKepBen2.Checked)
                    {
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepN1, numDaiLongKepN1.Value);
                        dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepN2, numDaiLongKepN2.Value);
                    }
                }
                else
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepCheck, 0);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen1, 0);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiLongKepBen2, 0);
                }
        ...
        private void CommandChoThepGia(Dictionary<string, object> dictCacGiaTriThepCanDoi)
        {
            ...
            if (tabControl2.TabPages.Contains(tpThepGia))
            {
                ...
                if (cbThepGia.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCheck, 1);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaDuongKinh, numThepGiaDuongKinh.Value);

                }
                else
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCheck, 0);
                    //dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaToiGoi1, 0);
                    //dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaToiGoi2, 0);
                }
                if (cbThepDaiGia.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaDaiGiaCheck, 1);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaDaiGiaDuongKinh, numThepGiaDaiDuongKinh.Value);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaDaiGiaKhoangCach, numThepGiaDaiKhoangRai.Value);
                }
                else
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaDaiGiaCheck, 0);
                }
            }
            else
            {
        ...
        private void CommandChoThepDai(Dictionary<string, object> dictCacGiaTriThepCanDoi)
        {
            ...
            if (cbKhaiBaoThepDai.Checked)
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCheck, 1);
            else
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiCheck, 0);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiGoi1DinhViD2, numThepDaiGoi1DinhVi.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiGoi1DuongKinh, numThepDaiGoi1DuongKinh.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiGoi1KhoangRai, numThepDaiGoi1KhoangCach.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiNhipDuongKinh, numThepDaiNhipDuongKinh.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiNhipKhoangRai, numThepDaiNhipKhoangCach.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiGoi2DuongKinh, numThepDaiGoi2DuongKinh.Value);
            dictCacGiaTriThepCanDoi.Add(CUltilities.thepDaiGoi2KhoangRai, numThepDaiGoi2KhoangCach.Value);
            ...
            try
            {
                if (tabControl2.TabPages.Contains(tpThepGiaCuong))
                {
                    if (cbGiaCuongGoi1.Checked)
                    {
                        ...
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1L2DuongKinh, numThepGiaCuongGoi1L2DuongKinh.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1L2SoLuong, numThepGiaCuongGoi1L2SoLuong.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1L2Check, 1);
                        }
                        else
                        {
                    ...
                    if (cbGiaCuongNhip.Checked)
                    {
                        ...
                        if (cbThepGiaCuongGL1.Checked)
                        {
                            ...
                            //dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1DinhViD2, numThepGiaCuongGoi1DinhVi.Value);
                            ...
                            if (!dictCacGiaTriThepCanDoi.ContainsKey(CUltilities.thepGiaCuongNhipDuongKinh))
                                dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongNhipDuongKinh, numThepGiaCuongNhipDuongKinh.Value);
                            else
                                dictCacGiaTriThepCanDoi[CUltilities.thepGiaCuongNhipDuongKinh] = numThepGiaCuongNhipDuongKinh.Value;


                            //dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongNhipLCheck, (cbAutoRangBuocNhip.Checked ? 0 : 1));
                            if (numThepGiaCuongNhipDinhVi.Value!=0)
                            {
                        ...
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongNhipL2DuongKinh, numThepGiaCuongNhipL2DuongKinh.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongNhipL2SoLuong, numThepGiaCuongNhipL2SoLuong.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongNhipL2Check, 1);
                        }
                        else
                        {
                    ...
                    if (cbGiaCuongGoi2.Checked)
                    {
                        ...
                        //    //if (!dictCacGiaTriThepCanDoi.ContainsKey(CUltilities.thepGiaCuongGoi1DinhViD2))
                        //    //    dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1DinhViD2, numThepGiaCuongGoi1DinhVi.Value);
                        //    //else
                        //    //    dictCacGiaTriThepCanDoi[CUltilities.thepGiaCuongGoi1DinhViD2] = numThepGiaCuongGoi1DinhVi.Value;
                        //    if (!dictCacGiaTriThepCanDoi.ContainsKey(CUltilities.thepGiaCuongGoi2DinhViD2))
                        //        dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2DinhViD2, numThepGiaCuongGoi2DinhVi.Value);
                        //    else
                        //        dictCacGiaTriThepCanDoi[CUltilities.thepGiaCuongGoi2DinhViD2] = numThepGiaCuongGoi2DinhVi.Value;
                        //}

                        if (cbThepGiaCuongD2L1.Checked)
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2DuongKinh, numThepGiaCuongGoi2DuongKinh.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2SoLuong, numThepGiaCuongGoi2SoLuong.Value);
                            //dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2DinhViD2, numThepGiaCuongGoi2DinhVi.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2Check, 1);
                        }
                        else
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2Check, 0);
                        }
                        if (cbThepGiaCuongD2L2.Checked)
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2L2DuongKinh, numThepGiaCuongGoi2L2DuongKinh.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2L2SoLuong, numThepGiaCuongGoi2L2SoLuong.Value);
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2L2Check, 1);
                        }
                        else
                        {
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2L2Check, 0);
                        }
                    }
                    else
                    {
                    ...
                    if (numThepGiaCuongGoi1DinhVi.Value!=0)
                    {
                    ...
                    {
                        if (!dictCacGiaTriThepCanDoi.ContainsKey(CUltilities.thepGiaCuongGoi1DinhViD2))
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi1DinhViD2, lengthDam / 4);
                        else
                            dictCacGiaTriThepCanDoi[CUltilities.thepGiaCuongGoi1DinhViD2] = lengthDam / 4;
                    }
                    if (numThepGiaCuongGoi2DinhVi.Value != 0)
                    {
                    ...
                    {
                        if (!dictCacGiaTriThepCanDoi.ContainsKey(CUltilities.thepGiaCuongGoi2DinhViD2))
                            dictCacGiaTriThepCanDoi.Add(CUltilities.thepGiaCuongGoi2DinhViD2, lengthDam / 4);
                        else
                            dictCacGiaTriThepCanDoi[CUltilities.thepGiaCuongGoi2DinhViD2] = lengthDam / 4;
        ...
        private void CommandChoThepChu(Dictionary<string, object> dictCacGiaTriThepCanDoi)
        {
            if (cbThepChu1Lop.Checked)
            {
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren1DuongKinh, numThepChuTren1DuongKinh.Value);
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren1SoLuong, numThepChuTren1SoLuong.Value);
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi1DuongKinh, numThepChuDuoi1DuongKinh.Value);
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi1SoLuong, numThepChuDuoi1SoLuong.Value);
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren2Check, 0);
                dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi2Check, 0);
            ...
            else
            {
                ...
                if (cbThepTren2.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren2Check, 1);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren2DuongKinh, numThepChuTren2DuongKinh.Value);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren2SoLuong, numThepChuTren2SoLuong.Value);
                }
                else dictCacGiaTriThepCanDoi.Add(CUltilities.thepTren2Check, 0);
                if (cbThepDuoi2.Checked)
                {
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi2Check, 1);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi2DuongKinh, numThepChuDuoi2DuongKinh.Value);
                    dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi2SoLuong, numThepChuDuoi2SoLuong.Value);
                }
                else dictCacGiaTriThepCanDoi.Add(CUltilities.thepDuoi2Check, 0);
            }
        }
        ...
        private void cbGiaCuongCheckChanged(object sender, EventArgs e)
        {
            ...
            switch (cb.Name)
            {
                case "cbGiaCuongGoi1":
                    gbThepGiaCuongDauDam1.Enabled = cb.Checked;
                    pnGiaCuongDau1L.Enabled = cb.Checked;
                    gbThepGiaCuongDauDam1.Visible = cb.Checked;
                    pnGiaCuongDau1L.Visible = cb.Checked;
                ...
                case "cbGiaCuongNhip":
                    ...
                    pnGiaCuongGiuaL.Enabled = cb.Checked;
                    pnGiaCuongGiuaL.Visible = cb.Checked;
                ...
                case "cbGiaCuongGoi2":
                    ...
                    pnGiaCuongDau2L.Visible = cb.Checked;
                    //if (cb.Checked)
                    //{
        ...
        private void tabControl1_DrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            ...
            //TabPage SelectedTab = tabControl2.TabPages[e.Index];

            //// Get the area of the header of this TabPage
            //System.Drawing.Rectangle HeaderRect = tabControl2.GetTabRect(e.Index);

            //// Create two Brushes to paint the Text
            //Brush BlackTextBrush = new SolidBrush(Color.Black);
            //Brush RedTextBrush = new SolidBrush(Color.DodgerBlue);
            //Pen pen = new Pen(RedTextBrush);
            //// Set the Alignment of the Text
            //StringFormat sf = new StringFormat();
            //sf.Alignment = StringAlignment.Center;
            //sf.LineAlignment = StringAlignment.Center;
            //Font BoldFont = new Font(label9.Font.FontFamily.Name, tabControl2.Font.Size, FontStyle.Regular);
            ...
            //    //e.Graphics.DrawRectangle(pen,SelectedTab., SelectedTab.Width,SelectedTab.Height);
            //    //DrawBorder(SelectedTab, Color.DodgerBlue, 1);
            //}
            //else
            //    e.Graphics.DrawString(SelectedTab.Text, BoldFont, BlackTextBrush, HeaderRect, sf);
        ...
        private void cbThepDaiCDungKep_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (cb.Checked)
            {
                cbThepDaiCDungKepBen1.Checked = true;
                cbThepDaiCDungKepBen2.Checked = true;

            }
            else
            {
                cbThepDaiCDungKepBen1.Checked = false;
                cbThepDaiCDungKepBen2.Checked = false;
        ...
        private void numThepChuTren1DuongKinh_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                defaultValue = new int[] { 14, 16, 18, 20, 25, 28, 32, 40 };
                tapHop = "{ 14, 16, 18, 20, 25, 28, 32, 40 }";
        ...
        private void pictureBox1_MouseHover(object sender, EventArgs e)
        {
            ...
            //FormGiaoDienDam2.ActiveForm.Size = new Size(1024, 850);
        ...
        private void pictureBox1_MouseLeave(object sender, EventArgs e)
        {
            ...
            //FormGiaoDienDam2.ActiveForm.Size = new Size(653, 502);
        }
        ...
        private void cbKhaiBaoThepDaiXoan_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cbKhaiBaoThepDai.Text = "_________________";
            }
        }
